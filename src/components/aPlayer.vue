    ...
    list: {
      ...
      default: () => {
        return [
          ...
          {
            title: 'River Flows In You', //歌曲名称
            artist: 'Martin Ermen', //演唱者
            lrc: '', //LRC 歌词或者歌词文件的 URL
            pic: '', //封面图片 URL
            src: 'https://music.163.com/song/media/outer/url?id=20110049.mp3' //音频文件的 URL,改掉网抑云网址上的url即可
          },
          {
            title: 'In A Notebook', //歌曲名称
            artist: 'Goldmund', //演唱者
            lrc: '', //LRC 歌词或者歌词文件的 URL
            pic: '', //封面图片 URL
            src: 'https://music.163.com/song/media/outer/url?id=18057481.mp3' //音频文件的 URL,改掉网抑云网址上的url即可
          },
          {
            title: '风居住的街道', //歌曲名称
            artist: '磯村由紀子', //演唱者
            lrc: '', //LRC 歌词或者歌词文件的 URL
            pic: '', //封面图片 URL
            src: 'https://music.163.com/song/media/outer/url?id=36897723.mp3' //音频文件的 URL,改掉网抑云网址上的url即可
          }
        ]
      }
    },
